        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-black text-gray-900 dark:text-white">{{ $table->name }}</h1>
                        <p class="text-gray-500 dark:text-gray-400">Table Details & Order Management</p>
                    </div>
                </div>
        ...
        @if($order)
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Current Order</h2>
                    ...
                    <div class="flex items-center gap-3">
                        @php
                            $statusConfig = [
                                ...
                                'served' => ['color' => 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300', 'icon' => '🍽️'],
                            ];
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                        ...
                        <div class="text-lg font-semibold text-gray-900 dark:text-white">{{ $order->created_at->format('M j, Y g:i A') }}</div>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                        ...
                        <div class="text-lg font-semibold text-gray-900 dark:text-white">{{ $orderItems->sum('quantity') }}</div>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                        ...
                        <div class="text-2xl font-bold text-indigo-600 dark:text-indigo-400">₦{{ number_format($orderItems->sum(fn($item) => $item->unit_price * $item->quantity)) }}</div>
                    </div>
                </div>
